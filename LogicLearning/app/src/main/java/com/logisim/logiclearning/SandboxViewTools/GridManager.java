...
/*
            :Welcome To the GridManager:
    a Grid class with all the information needed to create a 2D array of individual cells
    The grid is constructed of a 2D array of rectangles
    Grid Manipulation logic and Grid Information is stored here
...
public class GridManager {
    ...
    public GridManager(int numColumns, int numRows, int screenWidth, int screenHeight) {
